...
public class SiembraSQL {
	...
	public static final String FIND_BY_ID ="SELECT id_siembra, cantidad_siembra, fecha_siembra, observacion_siembra, fk_id_planta, nombre_planta, fk_id_empleado, nombre_empleado, apellido_empleado, fk_id_cama FROM "+TABLE_NAME+", empleado, planta WHERE fk_id_planta = id_planta and  fk_id_empleado = id_empleado and id_siembra = ? and activo_siembra = 'Y' ";
	...
	public static final String LIST = "SELECT id_siembra, cantidad_siembra, fecha_siembra, observacion_siembra, fk_id_planta, nombre_planta, fk_id_empleado, nombre_empleado, apellido_empleado, fk_id_cama FROM "+TABLE_NAME+", empleado, planta WHERE fk_id_planta = id_planta and  fk_id_empleado = id_empleado and activo_siembra = 'Y'";
