...
public class CamaSQL {
	...
	public static final String FIND_BY_ID ="SELECT id_cama, numero_cama, ancho_cama, largo_cama, lineas_cama, nlinea_cama, estado_cama, esterilizacion_cama, nombre_bloque, fk_id_bloque FROM "+TABLE_NAME+", bloque WHERE id_bloque = fk_id_bloque and id_cama = ?  and activo_cama = 'Y' ";
	...
	public static final String FIND_ESPACE ="SELECT lineas_cama, nlinea_cama FROM "+TABLE_NAME+" WHERE id_cama = ?  and activo_cama = 'Y'";
