...
public class CodigorfSQL {
	...
	public static final String FIND_BY_ID ="SELECT id_codigorf, nombre_codigorf, fk_id_planta FROM "+ TABLE_NAME+" where id_codigorf = ? and activo_codigorf = 'Y' ";
	...
	public static final String LIST = "SELECT id_codigorf, nombre_codigorf, fk_id_planta FROM "+TABLE_NAME+" where activo_codigorf = 'Y'";
