...
public class PlantaSQL {
	...
	public static final String FIND_BY_ID ="SELECT id_planta, nombre_planta, renombre_planta, esquejecf_planta, productividad_planta, flush_planta, flushs_planta, fk_id_breeder, g.nombre_breeder AS \"g.nombre_breeder\", fk_id_color1, a.nombre_es_color AS \"a.nombre_es_color\", fk_id_color2, c.nombre_es_color AS \"c.nombre_es_color\" FROM  "+TABLE_NAME+", color a, color c, breeder g where id_planta = ?  and activo_planta = 'Y'  and fk_id_breeder = g.id_breeder and fk_id_color1 = a.id_color and fk_id_color2 = c.id_color";
