...
public class PersonaSQL {
	...
	public static final String FIND_BY_ID ="SELECT id_persona, documento_persona, nombre_persona, telefono_persona, correo_persona, cargo_persona, codigo_persona, usuario_persona, contrasenia_persona FROM "+ TABLE_NAME+" where id_persona = ? and where activo_persona = 'Y'";
