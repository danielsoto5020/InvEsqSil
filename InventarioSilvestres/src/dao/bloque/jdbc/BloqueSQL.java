...
public class BloqueSQL {
	...
	public static final String FIND_BY_ID ="SELECT id_bloque, nombre_bloque, ncama_bloque, fk_id_finca FROM "+TABLE_NAME+", finca WHERE id_finca = fk_id_finca and id_bloque = ? and activo_bloque = 'Y' ";
	...
	public static final String LIST = "SELECT id_bloque, nombre_bloque, ncama_bloque, nombre_finca, fk_id_finca FROM "+TABLE_NAME+", finca WHERE id_finca = fk_id_finca and activo_bloque = 'Y' ";
