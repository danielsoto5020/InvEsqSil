...
public class IngresoSQL {
	...
	public static final String INSERT="INSERT INTO "+TABLE_NAME+" ( cantidad_ingreso, puesto_ingreso, nivel_ingreso, lado_ingreso, fecha_ingreso, fk_id_planta, fk_id_empleado, fk_id_cama, fk_id_siembra, activo_ingreso )  VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, 'Y' )";
